...
export default function RadioPlayer() {
  const [stations] = useState<RadioStation[]>([
    ...
    },
    {
      ...
      genre: "Lite Rock, Soft Hits & Slow Pop",
    ...
    },
    {
      ...
      genre: "Upbeat Karaoke & Trending Pop",
    ...
    {
      id: "ph_wish",
      name: "Wish 107.5 FM Manila 🌸",
      genre: "Acoustic Pop & Live Wish Bus Sessions",
    ...
    {
      id: "ph_barangay",
      name: "Barangay LS 97.1 FM (GMA) 🎙️",
      genre: "Barangay Desktop Pop & Upbeat Dance",
    ...
    {
      id: "ph_dwiz",
      name: "DWIZ 882 AM News Manila 📻",
      genre: "Live Philippine News & Commentary",
      streamUrl: "https://stream.zeno.fm/g66twphwawzuv",
      logo: "📻",
      country: "philippines"
    },
    // === JAPAN 🇯🇵 ===
